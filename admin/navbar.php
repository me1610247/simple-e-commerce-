...
<body>
  ...
  <p class="welcome">Welcome <?= ucwords($userName) ?> -</p>
    <div class="navibar">
      ...
      <p class="collection"><?=ucwords($pageName)?></p>
      <?php if (isset($_SESSION['admin'])) { ?>
      <ul class="nav-links" style="width:50%">
    ...
    <?php } else {
        ...
        <li><a href="../products/category.php">Category</a></li>
        <li><a href="../products/viewcart.php">Cart</a></li>
        <li><a href="../logout.php">Logout</a></li>
